...
?>
        ...
        <div class="container">
          <div class="jumbotron">
            ...
            <h2 class="text-center" style="color: pink;"> We Are Happy To Serve You! :) </h2>
          </div>
        </div>
        <br>

<h2 class="text-center"> Thank you for Ordering at Food Heaven! The ordering process is now complete.</h2>
...
<h4 class="text-center"> <strong>To Cancel Your Order/Give Food Instructions, Call Us At: 0900 78601 3456</strong> <span style="color: purple;"></span> </h4>
        </body>
