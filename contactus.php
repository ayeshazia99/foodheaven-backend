...
<html>
  ...
  <head>
    <title> Contact | Food Heaven </title>
  </head>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <li><a href="index.php" style="color:white; font-family:Papyrus;">Home</a></li>
            ...
            <li class="active"><a href="contactus.php" style="color:white; font-family:Papyrus;">Contact Us</a></li>
          </ul>
...
?>
          ...
          <li><a href="#" style="color:white; font-family:Papyrus;"> Welcome <?php echo $_SESSION['login_user1']; ?> </a></li>
            <li> <a href="managerlogin.php" style="color:white; font-family:Papyrus;">Manager Dashboard</a></li>
...
?>
    ...
    <div class="heading">
     <strong>Want to contact <span class="edit" style="color:purple; font-family:Papyrus;">Food Heaven? </span></strong>
     <br>
     <h2><a href="#" style="color:white; font-family:Papyrus;">Fill the form below for feedback/complaints/Queries.</a></h2>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
           <textarea class="form-control" type="textarea" id="message" name="message" placeholder="Write your message" maxlength="140" rows="7"></textarea>
