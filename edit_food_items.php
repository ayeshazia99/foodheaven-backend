      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse " id="myNavbar">
          ...
          <li><a href="#" style="color:white; font-family:Papyrus;"> Welcome <?php echo $login_session; ?> </a></li>
            <li class="active"> <a href="managerlogin.php" style="color:white; font-family:Papyrus;">Manger Dashboard</a></li>
 ...
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="dprice" name="dprice" value=<?php echo $row1['price'];  ?> placeholder="Your Food Price (PKR)" required="">
          </div>
