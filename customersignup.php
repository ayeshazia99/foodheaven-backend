<html>
<head>
    <title> Signup | Food Heaven </title>
  </head>
  ...
  <body>
   ...
   <h4>Fill the form below to create your account</h4>
    </div>
    </div>
      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="customer_registered_success.php" method="POST">
          ...
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="fullname" type="text" name="fullname" placeholder="Enter Full Name" required="" autofocus="">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="contact" type="number" name="contact" placeholder="Enter your ContactNo" required="">
              <span class="input-group-btn">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="password" type="password" name="password" placeholder="Enter a strong password" required="">
              <span class="input-group-btn">
