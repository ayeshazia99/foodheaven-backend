...
?>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="myrestaurant.php" style="color:white; font-family:Papyrus;">MANAGER CONTROL PANEL</a></li>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            <li><a href="#" style="color:white; font-family:Papyrus;"></span> Welcome <?php echo $_SESSION['login_user2']; ?> </a></li>
            <li class="active" ><a href="foodlist.php" style="color:white; font-family:Papyrus;"> Food Zone </a></li>
            <li><a href="cart.php" style="color:white; font-family:Papyrus;">Cart  (<?php
              ...
              echo "$count"; 
                ...
                echo "0";
              ?>) </a></li>
            <li><a href="logout_u.php" style="color:white; font-family:Papyrus;">Log Out </a></li>
          </ul>
  <?php        
}
else {
...
<div class="jumbotron">
  ...
  <div class="container text-align-center" style="color:purple; font-family:Papyrus;">
    <h1>Welcome To Food Heaven</h1>      
    <p>Delve in a World of Heavenly Food!</p>
  </div>
</div>
