...
if(!empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        ...
        <h3 style="text-align:center">Looks finger licking' good!</h3>
...
<th width="20%">Price Details(PKR)</th>
<th width="15%">Order Total(PKR)</th>
...
?>
<tr>
<td colspan="3" align="right">Total(IN PKR)</td>
...
if(empty($_SESSION["cart"]))
{
  ...
  <div class="container">
      <div class="jumbotron">
        ...
        <p>Go back and <a href="foodlist.php">order more food!</a></p>
